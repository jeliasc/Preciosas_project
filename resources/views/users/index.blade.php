...
@section('js')
    ...
    <script src="{{ asset('js/preciosas/users/userCreate.js') }}"></script>
    <script src="{{ asset('js/preciosas/users/userUpdate.js') }}"></script>
    <script src="{{ asset('js/preciosas/users/userDelete.js') }}"></script>
@stop
