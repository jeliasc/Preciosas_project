...
return [
    ...
    */
    ...
    'menu' => [
        ...
        ['header' => 'labels', 'can'  => 'manage-labels'],
        [
            'text'       => 'important',
            'icon_color' => 'red',
            'url'        => '#',
        ...
        'Sweetalert2' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/sweetalert2@11.7.28/dist/sweetalert2.all.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/sweetalert2@11.7.28/dist/sweetalert2.min.css   ',
                ],
            ],
        ],
        'Pace' => [
        ...
        'font-awesome' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//kit.fontawesome.com/8ff7a371a4.js',
                ],
            ],
        ],
    ],
